...
def forecast_dec2019():
    ...
    fm.hires_forecast(ti=datetimeify(ti), tf=datetimeify(tf), recalculate=True, 
        save='{:s}\\forecast_hires_'.format(fm.plotdir)+'.png', n_jobs=n_jobs, threshold=threshold, root='hires')
